                    ...
                    NavHost(
                        ...
                        composable<GymLocationsScreen> {
                            GymLocationsScreen(
                                ...
                                when (gymLocation) {
                                    "Clontarf" -> {
                                        navController.navigate(PersonalTrainersScreen(gymLocation = GymLocation.CLONTARF)) {
                                            restoreState = true
                                        }
                                    }

                                    "Aston Quay" -> {
                                        navController.navigate(PersonalTrainersScreen(gymLocation = GymLocation.ASTONQUAY)) {
                                            restoreState = true
                                        }
                                    }

                                    "Leopardstown" -> {
                                        navController.navigate(PersonalTrainersScreen(gymLocation = GymLocation.LEOPARDSTOWN)) {
                                            restoreState = true
                                        }
                                    }

                                    "Westmanstown" -> {
                                        navController.navigate(PersonalTrainersScreen(gymLocation = GymLocation.WESTMANSTOWN)) {
                                            restoreState = true
                                        }
                                    }
