...
fun PersonalTrainerItem(
  ...
  Card(
    ...
    Column(modifier = Modifier.padding(16.dp)) {
      Row {
        Avatar(imageUrl = personalTrainer.imageUrl, contentDescription = personalTrainer.firstName)
        ...
        Column(modifier = Modifier.padding(start = 16.dp)) {
          ...
          Text(text = "Qualifications", style = MaterialTheme.typography.titleSmall)
          Text(
      ...
      Button(
        ...
        onClick = { onBookTrainerClick(personalTrainer) },
      ) {
        Text("Book now")
      }
    }
...
private fun SocialImage(
  ...
  Image(
    ...
    modifier = modifier.size(24.dp).clickable { onSocialLinkClick(socials.value) },
  )
}
