...
private data class ShimmerElement(
    ...
    override fun create() = ShimmerNode(progress, inboundColor, outboundColor)
...
private class ShimmerNode(var progress: Float, var inboundColor: Long, var outboundColor: Long) :
