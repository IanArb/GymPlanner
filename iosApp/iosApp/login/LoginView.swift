                    ...
                    TextField("Username", text: $username)
                        ...
                        .overlay(
                            RoundedRectangle(cornerRadius: 4)
                                .stroke(
                                    usernameError != nil && attemptedLogin ? Color.red
                                        .opacity(0.3) : Color.gray.opacity(0.3),
                                    lineWidth: 1
                                )
                        )
                ...
                VStack(alignment: .leading, spacing: 8) {
                    SecureField("Password", text: $password)
                        ...
                        .overlay(
                            RoundedRectangle(cornerRadius: 4)
                                .stroke(
                                    passwordError != nil && attemptedLogin ? Color.red
                                        .opacity(0.3) : Color.gray.opacity(0.3),
                                    lineWidth: 1
                                )
                        )
                ...
                HStack(spacing: 12) {
                    Button(action: {
                        ...
                        Image(systemName: rememberMe ? "checkmark.square.fill" : "square")
                            .foregroundColor(
                                rememberMe ? Color(red: 0.27, green: 0.35, blue: 0.49) :
                                    Color.gray
                            )
                            .font(.title3)
                    }
