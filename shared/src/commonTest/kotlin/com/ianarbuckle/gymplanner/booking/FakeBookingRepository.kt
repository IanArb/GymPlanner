...
class FakeBookingRepository(
    ...
    override suspend fun saveBooking(booking: Booking): Result<BookingResponse> = try {
    ...
    override suspend fun findBookingsByUserId(userId: String): Result<ImmutableList<BookingResponse>> = try {
