...
class FakePersonalTrainersRepository(
    ...
    suspend fun getPersonalTrainers(gymLocation: GymLocation): Result<List<PersonalTrainer>> = try {
    ...
    suspend fun getPersonalTrainerById(id: String): Result<PersonalTrainer> = try {
    ...
    ): Result<List<PersonalTrainer>> = try {
