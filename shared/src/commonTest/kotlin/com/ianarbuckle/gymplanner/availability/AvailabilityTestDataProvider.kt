...
object AvailabilityTestDataProvider {
    ...
    object TimeDtos {
        val morning9am =
            TimeDto(id = "time-001", startTime = "09:00", endTime = "10:00", status = "available")

        val morning10am =
            TimeDto(id = "time-002", startTime = "10:00", endTime = "11:00", status = "available")

        val afternoon2pm =
            TimeDto(id = "time-003", startTime = "14:00", endTime = "15:00", status = "booked")

        val afternoon3pm =
            TimeDto(id = "time-004", startTime = "15:00", endTime = "16:00", status = "available")

        val evening6pm =
            TimeDto(id = "time-005", startTime = "18:00", endTime = "19:00", status = "unavailable")
    }
    ...
    object Times {
        val morning9am =
            Time(id = "time-001", startTime = "09:00", endTime = "10:00", status = "available")

        val morning10am =
            Time(id = "time-002", startTime = "10:00", endTime = "11:00", status = "available")

        val afternoon2pm =
            Time(id = "time-003", startTime = "14:00", endTime = "15:00", status = "booked")

        val afternoon3pm =
            Time(id = "time-004", startTime = "15:00", endTime = "16:00", status = "available")

        val evening6pm =
            Time(id = "time-005", startTime = "18:00", endTime = "19:00", status = "unavailable")
    }
    ...
    object SlotDtos {
        ...
        val wednesday =
            SlotDto(id = "slot-003", date = "2025-01-08", times = listOf(TimeDtos.evening6pm))

        val emptySlot = SlotDto(id = "slot-004", date = "2025-01-09", times = emptyList())
    }
    ...
    object Slots {
        ...
        val wednesday =
            Slot(id = "slot-003", date = "2025-01-08", times = persistentListOf(Times.evening6pm))

        val emptySlot = Slot(id = "slot-004", date = "2025-01-09", times = persistentListOf())
    }

    // ========== Availability DTOs ==========

    object AvailabilityDtos {
        val januaryWithSlots =
            AvailabilityDto(
                id = "avail-001",
    ...
    object CheckAvailabilities {
        val available =
            CheckAvailability(personalTrainerId = PersonalTrainerIds.trainer1, isAvailable = true)

        val unavailable =
            CheckAvailability(personalTrainerId = PersonalTrainerIds.trainer2, isAvailable = false)

        val trainer3Available =
            CheckAvailability(personalTrainerId = PersonalTrainerIds.trainer3, isAvailable = true)
    }
