...
class DefaultAvailabilityRepository : AvailabilityRepository, KoinComponent {
  ...
  override suspend fun getAvailability(
    ...
    return try {
      val availabilityDto =
        remoteDataSource.fetchAvailability(personalTrainerId = personalTrainerId, month = month)
  ...
  override suspend fun checkAvailability(
    ...
    return try {
      val checkAvailabilityDto =
        remoteDataSource.checkAvailability(personalTrainerId = personalTrainerId, month = month)
