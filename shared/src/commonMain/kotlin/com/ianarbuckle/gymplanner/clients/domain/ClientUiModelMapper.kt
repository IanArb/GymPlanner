...
object ClientUiModelMapper {
    fun ClientDto.transformToClient(): Client = Client(
        firstName = firstName,
        surname = surname,
    ...
    private fun GymPlanDto.transformGymPlan(): GymPlan = GymPlan(
        name = name,
    ...
    private fun PersonalTrainerDto.transformPersonalTrainer(): PersonalTrainer = PersonalTrainer(
        firstName = firstName,
        lastName = lastName,
        bio = bio,
        imageUrl = imageUrl,
    ...
    private fun GymLocationDto.transformToGymLocation(): GymLocation = when (this) {
    ...
    private fun SessionDto.transformSession(): Session = Session(name = name, workout = workouts.map { workout -> workout.transformWorkout() })

    private fun WorkoutDto.transformWorkout(): Workout = Workout(
        name = name,
        sets = sets,
