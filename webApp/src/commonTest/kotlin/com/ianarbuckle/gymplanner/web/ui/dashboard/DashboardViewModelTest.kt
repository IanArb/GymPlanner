...
class DashboardViewModelTest : KoinTest {
    ...
    @Test
    fun `initial uiState is Idle`() = testScope.runTest {
    ...
    @Test
    fun `fetchFacilities with multiple facilities sets uiState to Success`() = testScope.runTest {
    ...
    @Test
    fun `fetchFacilities with multiple facilities returns correct list`() = testScope.runTest {
        fakeFacilitiesRepository.result = Result.success(TestData.multipleFacilities)
    ...
    @Test
    fun `fetchFacilities with single facility sets uiState to Success`() = testScope.runTest {
    ...
    @Test
    fun `fetchFacilities with empty list sets uiState to Success with empty facilities`() = testScope.runTest {
    ...
    @Test
    fun `fetchFacilities passes gymLocation to repository`() = testScope.runTest {
        fakeFacilitiesRepository.result = Result.success(emptyList())
    ...
    @Test
    fun `fetchFacilities with network error sets uiState to Error`() = testScope.runTest {
    ...
    @Test
    fun `fetchFacilities with network error sets correct error message`() = testScope.runTest {
        fakeFacilitiesRepository.result = Result.failure(Exception("Network unavailable"))
    ...
    @Test
    fun `fetchFacilities with server error sets uiState to Error`() = testScope.runTest {
    ...
    @Test
    fun `fetchFacilities with server error sets correct error message`() = testScope.runTest {
        fakeFacilitiesRepository.result = Result.failure(RuntimeException("Internal server error"))
    ...
    @Test
    fun `fetchFacilities with thrown exception sets uiState to Error`() = testScope.runTest {
    ...
    @Test
    fun `fetchFacilities with failure and null message uses fallback message`() = testScope.runTest {
    ...
    @Test
    fun `fetchFacilities called twice returns latest result`() = testScope.runTest {
        fakeFacilitiesRepository.result = Result.success(listOf(TestData.treadmillOperational))
    ...
    @Test
    fun `fetchFacilities success followed by error sets uiState to Error`() = testScope.runTest {
        fakeFacilitiesRepository.result = Result.success(listOf(TestData.treadmillOperational))
